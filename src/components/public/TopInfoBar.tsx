  ...
  return (
    <div className="bg-espresso text-nude-200/80 text-[11px] hidden lg:block">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-8">
        ...
        {/* Center: trust badges */}
        <div className="flex items-center gap-4 text-nude-200/50">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="text-nude-200/50 hover:text-white transition-colors"
            aria-label="WhatsApp"
          >
          ...
          <a
            href="https://www.facebook.com/profile.php?id=61591480246246"
            target="_blank"
            rel="noopener noreferrer"
            className="text-nude-200/50 hover:text-white transition-colors"
            aria-label="Facebook"
