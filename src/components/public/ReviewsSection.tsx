  ...
  return (
    <section className="py-20 bg-nude-50/40">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Review cards */}
        {hasReviews && (
          <div className={`${displayed.length === 1 ? "max-w-sm mx-auto" : displayed.length === 2 ? "grid grid-cols-1 md:grid-cols-2 gap-3 max-w-3xl mx-auto" : "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3"} mb-14 items-start`}>
