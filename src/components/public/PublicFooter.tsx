...
const linkClass = "text-sm text-nude-200/70 hover:text-white transition-colors";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/offer" className={linkClass}>{t("navbar.hair")}</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="mailto:info@hairland.cz" className={linkClass}>
                  info@hairland.cz
                </a>
              </li>
              <li>
                <a href="tel:+420608553103" className={linkClass}>
                  +420 608 553 103
                </a>
              </li>
              <li className="text-sm text-nude-200/50 pt-1">
