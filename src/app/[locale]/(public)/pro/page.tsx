...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title,
    description: desc,
    alternates: getAlternates("/pro", locale),
    openGraph: {
      type: "website",
      title: `${title} | Hairland`,
      description: desc,
      url: getOgUrl("/pro", locale),
      siteName: "Hairland",
      locale: OG_LOCALES[locale] ?? "cs_CZ",
      images: [
        {
          url: "https://www.hairland.cz/og/og-pro.jpg",
          width: 1200,
          height: 630,
          alt: "Spolupráce pro kadeřnice a salony",
        },
      ],
    },
    twitter: {
      ...
      title: `${title} | Hairland`,
      description: desc,
      images: ["https://www.hairland.cz/og/og-pro.jpg"],
    },
  };
}
