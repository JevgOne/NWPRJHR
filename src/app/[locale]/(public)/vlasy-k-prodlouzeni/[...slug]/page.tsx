...
async function generateProductMetadataFromProduct(
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: `/api/og/product/${productSlug}`,
          width: 1200,
          height: 630,
          alt: ogTitle,
        },
      ...
      <section className="mt-8">
        <div className="rounded-2xl bg-gradient-to-br from-amber-50/60 to-nude-50 p-6 space-y-4 border border-amber-100/50">
          ...
          <div className="space-y-1.5 pt-1">
            <Link href={{ pathname: '/kosik' as any, query: { mode: 'consult', reason: 'real-photo' } }} className="flex items-start gap-2.5 rounded-lg p-2 -mx-2 hover:bg-white/60 transition-colors">
            ...
            <Link href={{ pathname: '/kosik' as any, query: { mode: 'consult', reason: 'photo-match' } }} className="flex items-start gap-2.5 rounded-lg p-2 -mx-2 hover:bg-white/60 transition-colors">
