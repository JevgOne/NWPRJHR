...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: getAlternates("/doprava", locale),
    openGraph: {
      type: "website",
      ...
      images: [
        {
          url: "https://www.hairland.cz/og/og-doprava.jpg",
          width: 1200,
          height: 630,
          alt: "Doprava a doručení vlasů k prodloužení",
        },
      ],
    },
    twitter: {
      ...
      title: `${t("dopravaTitle")} | Hairland`,
      description: t("dopravaDescription"),
      images: ["https://www.hairland.cz/og/og-doprava.jpg"],
    },
  };
}
