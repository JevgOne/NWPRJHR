...
export default async function SlovanskVlasyPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
      ...
      {/* 3. Původ a kvalita */}
      <section className="mb-14">
        <h2 className="text-xl font-semibold text-ink mb-2">{t("originTitle")}</h2>
        <p className="text-sm text-muted leading-relaxed max-w-3xl">
          {t("originText")}
        </p>
      </section>
      ...
      {/* 4. Pro koho */}
      <section className="mb-14">
        <h2 className="text-xl font-semibold text-ink mb-2">{t("forWhomTitle")}</h2>
        <p className="text-sm text-muted leading-relaxed max-w-3xl">
          {t("forWhomText")}
        </p>
      </section>
