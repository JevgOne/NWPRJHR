...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: getAlternates("/obchodni-podminky", locale),
    openGraph: {
      type: "website",
      title: `${t("obchodniTitle")} | Hairland`,
      description: t("obchodniDescription"),
      url: getOgUrl("/obchodni-podminky", locale),
      siteName: "Hairland",
      locale: OG_LOCALES[locale] ?? "cs_CZ",
      images: [
        {
          url: "https://www.hairland.cz/og/og-obchodni-podminky.jpg",
          width: 1200,
          height: 630,
          alt: "Obchodní podmínky e-shopu",
        },
      ],
    },
    twitter: {
      ...
      title: `${t("obchodniTitle")} | Hairland`,
      description: t("obchodniDescription"),
      images: ["https://www.hairland.cz/og/og-obchodni-podminky.jpg"],
    },
  };
}
