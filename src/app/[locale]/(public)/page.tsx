...
const webSiteJsonLd = {
  ...
  "@type": "WebSite",
  name: "Hairland",
  alternateName: ["Hairland.cz", "Hair Land"],
  url: "https://www.hairland.cz",
  potentialAction: {
    "@type": "SearchAction",
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-line pt-6 sm:pt-8 mt-2">
            ...
            <div className="flex flex-wrap justify-center gap-1.5 sm:gap-2">
              {([
                { slug: "clip-in", href: "/clip-in-vlasy" },
                { slug: "tape-in", href: "/tape-in-vlasy" },
                { slug: "keratin", href: "/keratinove-vlasy" },
                { slug: "micro-ring", href: "/micro-ring-vlasy" },
      ...
      <section className="py-10 sm:py-14 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-3">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <details key={i} className="group bg-nude-50 rounded-xl border border-line">
                <summary className="px-5 py-4 cursor-pointer font-semibold text-ink text-sm flex items-center justify-between">
                  {t(`landing.faq${i}Q` as any)}
                  <svg className="w-4 h-4 text-muted transition-transform group-open:rotate-180 flex-shrink-0 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
                </summary>
                <div className="px-5 pb-4 text-sm text-muted leading-relaxed">
                  {t(`landing.faq${i}A` as any)}
                </div>
              </details>
            ))}
          </div>
