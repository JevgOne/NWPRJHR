...
const NAMESPACE = "virginLP";
const PATH = "/panenske-vlasy";
...
export default async function PanenskeVlasyPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
      ...
      {/* 2. Co jsou panenské vlasy */}
      <section className="mb-14">
        <h2 className="text-xl font-semibold text-ink mb-2">{t("whatTitle")}</h2>
      ...
      {/* 3. Proč stojí více */}
      <section className="mb-14">
        <h2 className="text-xl font-semibold text-ink mb-2">{t("whyMoreTitle")}</h2>
        <p className="text-sm text-muted leading-relaxed max-w-3xl">
          {t("whyMoreText")}
        </p>
      </section>
      ...
      {/* 4. Životnost a péče */}
      <section className="mb-14">
        <h2 className="text-xl font-semibold text-ink mb-2">{t("lifespanTitle")}</h2>
        <p className="text-sm text-muted leading-relaxed max-w-3xl">
          {t("lifespanText")}
        </p>
      </section>
      ...
      <section className="mb-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            <div className="text-sm font-semibold text-ink mb-1">
              {t("crossUkrainianTitle")}
            </div>
            <p className="text-sm text-muted">{t("crossUkrainianText")}</p>
          </Link>
        </div>
      </section>
